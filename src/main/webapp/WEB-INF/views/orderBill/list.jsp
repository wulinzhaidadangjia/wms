            ...
            <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                ...
                <c:forEach var="ob" items="${result.list}" varStatus="v">
                    <tr>
                        ...
                        <td>
                            <c:if test="${ob.status==0}">
                                <a href="/orderBill/input.do?id=${ob.id}">编辑</a>
                                <a href="javascript:" class="btn_delete"
                                   data-url="/orderBill/delete.do?id=${ob.id}"
                                   data-obj="/orderBill/list.do">删除</a>
                                <a href="javascript:" class="btn_audit"
                                   data-url="/orderBill/audit.do?id=${ob.id}"
                                   data-obj="/orderBill/list.do">审核</a>
                            </c:if>
                            <c:if test="${ob.status==1}">
                                <a href="/orderBill/view.do?id=${ob.id}">查看</a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
